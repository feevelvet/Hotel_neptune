...
if (!isset($_GET['pieces']) || !isset($_GET['prix']) || !isset($_GET['personnes'])) {
    $requete = "SELECT * FROM Chambres WHERE Id <= 6 ";
} else {
    $requete = "SELECT * FROM Chambres WHERE Id <= 6 AND Pieces >= $pieces AND Prix <= $prix AND Personne >= $personnes";
}
// Exécuter la requête
...
<body style="background-color: #333;">
    ...
    <form method="get" action="luxe.php">
